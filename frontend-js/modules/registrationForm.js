   ...
   passwordHandler(){
    ...
    passwordImmediately(){
        ...
        if(this.password.value.length>50){
            ...
            this.showValidationError(this.password,"Password cant be greater than 50 characters")
        }
    ...
    passwordAfterDelay(){
        if(this.password.value.length<12){
            this.showValidationError(this.password,"Password must be greater than 12 characters")
        }
    }
    emailAfterDelay(){
